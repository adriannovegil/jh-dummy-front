package es.devcircus.jhdummy.web.rest;

import es.devcircus.jhdummy.JhdummyApp;
import es.devcircus.jhdummy.domain.Authority;
import es.devcircus.jhdummy.domain.User;
import es.devcircus.jhdummy.repository.UserRepository;
import es.devcircus.jhdummy.security.AuthoritiesConstants;
import es.devcircus.jhdummy.service.MailService;
import es.devcircus.jhdummy.service.UserService;
import es.devcircus.jhdummy.service.dto.UserDTO;
import es.devcircus.jhdummy.service.mapper.UserMapper;
import es.devcircus.jhdummy.web.rest.errors.ExceptionTranslator;
import es.devcircus.jhdummy.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = JhdummyApp.class)
